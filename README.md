...
AndroidX adaptive window APIs, and Mozilla GeckoView. Beta 1 provides real independent browser
tabs, a visual tab overview, dedicated settings, and compact/tablet/desktop interfaces driven by
the current app window.

## Current release

`1.0.0-beta.1` is an early testing release. It is suitable for sideloading and UI testing, but it
is not yet intended to replace a daily-use browser.
